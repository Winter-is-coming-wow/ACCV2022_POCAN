...
class DataLoader:
    ...
    def translabel(self, dataset, label):
        if dataset == 'fer2013':
            ...
            label = self.args.sfew_uniform[label]
        else:
...
class RAFdataset:
    def __init__(self):
        ...
        self.train_tfrecord_path = r'G:/superwang/RAF/RAF_train_tfrecord'
        # self.test_tfrecord_path = r'G:\demo\cross_dataset\datasets\RAF_test_tfrecord'
        self.test_tfrecord_path = r'G:/superwang/RAF/RAF_test_tfrecord'
